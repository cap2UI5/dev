...
/**
 * z2ui5_cl_ui5_app_cont — JS port of abap2UI5 z2ui5_cl_ui5_app_cont.
 *
...
class z2ui5_cl_ui5_app_cont {
  ...
  static _buffer_set(id, r) {
    z2ui5_cl_ui5_app_cont._mt_buffer.delete(id);
    z2ui5_cl_ui5_app_cont._mt_buffer.set(id, r);
    while (z2ui5_cl_ui5_app_cont._mt_buffer.size > z2ui5_cl_ui5_app_cont._mt_buffer_max) {
      z2ui5_cl_ui5_app_cont._mt_buffer.delete(z2ui5_cl_ui5_app_cont._mt_buffer.keys().next().value);
    }
  }
  ...
  static all_xml_parse(xml) {
    const r = new z2ui5_cl_ui5_app_cont();
    try {
   ...
   */
  static db_load(id) {
    if (z2ui5_cl_ui5_app_cont._mt_buffer.has(id)) {
      return z2ui5_cl_ui5_app_cont._mt_buffer.get(id);
    }
    try {
      const ls_db = new DB().read_draft(id);
      const r = z2ui5_cl_ui5_app_cont.all_xml_parse(ls_db.data);
      r.ms_draft.id = String(id ?? ``);
      z2ui5_cl_ui5_app_cont._buffer_set(id, r);
      return r;
  ...
  static get mt_buffer() {
    return [...z2ui5_cl_ui5_app_cont._mt_buffer.entries()].map(([id, app]) => ({ id, app }));
  }
  ...
  static db_load_buffer_clear() {
    z2ui5_cl_ui5_app_cont._mt_buffer.clear();
  }

  _create_model() {
    return new z2ui5_cl_ui5_srv_model({ attri: this.mt_attri, app: this.mo_app });
  }
  ...
  static async run(oApp, oClient, oReq, requireOwn = false) {
    z2ui5_cl_ui5_srv_model.main_json_to_attri(oApp, oReq?.XX, requireOwn);
...
module.exports = z2ui5_cl_ui5_app_cont;
